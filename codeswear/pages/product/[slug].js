                  ...
                  {Object.keys(variants).includes("white") &&
                    Object.keys(variants["white"]).includes(size) && (
                      <button
                        ...
                        className={`border-2
             border-gray-800 rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  {Object.keys(variants).includes("red") &&
                    Object.keys(variants["red"]).includes(size) && (
                      <button
                        ...
                        className={`border-2
             border-gray-800 ml-1 bg-gray-700 rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  {Object.keys(variants).includes("green") &&
                    Object.keys(variants["green"]).includes(size) && (
                      <button
                        ...
                        className={`border-2
             border-gray-800 ml-1 bg-green-500 rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  {Object.keys(variants).includes("blue") &&
                    Object.keys(variants["blue"]).includes(size) && (
                      <button
                        ...
                        className={`border-2
             border-gray-800 ml-1 bg-blue-500 rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  {Object.keys(variants).includes("purple") &&
                    Object.keys(variants["purple"]).includes(size) && (
                      <button
                        ...
                        className={`border-2
             border-gray-800 ml-1 bg-purple-500 rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  {Object.keys(variants).includes("yellow") &&
                    Object.keys(variants["yellow"]).includes(size) && (
                      <button
                        ...
                        className={`border-2
             border-gray-800 ml-1 bg-yellow-500 rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  {Object.keys(variants).includes("black") &&
                    Object.keys(variants["black"]).includes(size) && (
                      <button
                        ...
                        className={`border-2
             border-gray-800 ml-1 bg-black rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  <div className="relative">
                    ...
                    >
                      {Object.keys(variants[color]).includes("S") && (
                        <option className="bg-gray-500">S</option>
                      )}
                      {Object.keys(variants[color]).includes("M") && (
                        <option className="bg-gray-500">M</option>
                      )}
                      {Object.keys(variants[color]).includes("L") && (
                        <option className="bg-gray-500">L</option>
                      )}
                      {Object.keys(variants[color]).includes("XL") && (
                        <option className="bg-gray-500">XL</option>
                      )}
                      {Object.keys(variants[color]).includes("XXL") && (
                        <option className="bg-gray-500">XXL</option>
                      )}
